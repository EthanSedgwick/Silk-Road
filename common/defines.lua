...
country = {
	...
	INVESTMENT_SCORE_FACTOR = 0.015, -- how much foreign investment money counts towards your industry score
...
diplomacy = {
	...
	BREAKTRUCE_INFAMY_DEMAND_STATE = 3,
